...
class CreateGrupMenuItemTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('grup_menu_item', function (Blueprint $table) {
            ...
            $table->string('grup_menu_item_tambah', 5)->default('tidak')->comment('ya | tidak');
            $table->string('grup_menu_item_ubah', 5)->default('tidak')->comment('ya | tidak');
            $table->string('grup_menu_item_hapus', 5)->default('tidak')->comment('ya | tidak');
